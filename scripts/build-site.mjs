...
${conf.pricing ? `<section class="section container"><h2>方案與價格</h2><div class="grid cards">${conf.pricing.map((p) => `<article class="card"><h3>${p.name}</h3><p>${p.price}</p><p>${p.detail}</p></article>`).join("")}</div></section>` : ""}
...
const servicesConfig = [
  ...
  { slug: "event", path: "/services/event-photography/", title: "活動攝影・會議紀錄・企業活動錄影｜照片・精華影片・多機全程錄影", h1: "活動攝影 / 會議紀錄服務", hero: "擅長大型活動、企業論壇、室內會議與運動賽事，提供穩定專業流程與高畫質交件。", description: "活動會議攝影服務，含拍照、精華影片、多機全程錄影。", points:["專業商業攝影 15 年","百家企業指定合作","高畫質照片與影片流程","支援行銷曝光與結案報告"], pricing:[{name:"全程活動拍照",price:"NT$8,800 未稅",detail:"3 小時內，至少 200 張，雲端交件與基礎修圖"},{name:"精華影片製作",price:"NT$8,800 未稅",detail:"2-5 分鐘重點影片，適合社群與品牌曝光"},{name:"舞台活動全程錄影（多機）",price:"NT$8,800 未稅",detail:"3 機同步拍攝，完整內容回放"}] },
